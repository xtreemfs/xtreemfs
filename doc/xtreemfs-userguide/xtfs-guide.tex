...
<configuration>
  ...
  <property>
    ...
    <description>
      ...
      when another file is renamed to the existing file's
      path. Defaults to false for Hadoop FileSystem Contract
      conformance; for POSIX conformance, set this to true.
    </description>
  </property>
