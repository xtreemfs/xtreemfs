...
\item \texttt{2} - WARNING: Storage could be in an critical state soon. The OSD will (not) filtered out (depending on the osd\_health\_status attribute) when the default OSD selection policy is used.
