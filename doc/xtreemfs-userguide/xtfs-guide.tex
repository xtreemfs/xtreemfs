...
\begin{itemize}
\item XtreemFS servers (v 1.3.2 or newer) including XtreemFS.jar and Foundation.jar (\href{http://www.XtreemFS.org}{www.XtreemFS.org})
...
\item Configure Hadoop to use XtreemFS instead of HDFS:
	...
	If you run a Linux-based OS these jar-libraries are located at '\textit{/usr/share/java/}'. We assume you also put the downloaded HadoopClient.jar there.
	...
	\item Now you have to specify some properties in \textit{core-site.xml} which also has to be in the \textit{conf} 
