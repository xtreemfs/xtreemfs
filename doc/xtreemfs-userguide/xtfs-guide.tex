...
This document is \copyright{} 2009-\the\year{} by Bj\"orn Kolbeck, Jan Stender, Michael Berlin, Matthias Noack, Paul Seiferth, Felix Langner, NEC HPC Europe, Felix Hupfeld, Juan Gonzales, Patrick Sch\"afer. All rights reserved.
...
<configuration>
  ...
  <property>
    <name>xtreemfs.volumeNames</name>
    <value>volumeName1,volumeName2,...</value>
    <description>
       Names of the volumes to use within XtreemFS.
       The first volume is used as the default volume.    
    </description>
  </property>
  ...
  <property>
	...
	\item The third property specifies the names of the volumes to use within XtreemFS. The first volume is used as the default 	volume. This volume is used if no volume is specified in a path. Make sure, that the volumes (here named 							\textit{volumeName1,volumeName2,...}) do exist. If the volumes are not available Hadoop will not be able to use XtreemFS.
