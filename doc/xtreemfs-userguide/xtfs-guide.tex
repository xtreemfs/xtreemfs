...
\begin{verbatim}
 $> mount.xtreemfs --vivaldi-enable true \
...
Clients can also be told to send their coordinates to the DIR by adding \verb+--vivaldi--enable-dir-updates true+ to the mount command.
