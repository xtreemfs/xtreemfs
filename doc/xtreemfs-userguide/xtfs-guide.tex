...
\subsubsection{\texttt{renewal\_signal} \textit{optional}}
\begin{tabular}{lp{10cm}}
 Services & MRC, OSD\\
 Values   & true, false\\
 Default  & false\\
 Description & If set to true, the service will try to register a signal handler for USR2 upon which it renews its address mapping. Since some VMs are using USR2 internally, this parameter should be used together with the VM option -XX:+UseAltSigs.
\end{tabular}
