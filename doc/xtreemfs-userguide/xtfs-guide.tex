...
XtreemFS is capable of taking file system snapshots. A snapshot caputures an instantaneous image of all files and directories in a volume, which can later be accessed in a read-only manner.
