...
for custom_SConscript in ["xtfs_send_custom.SConscript"]:
    if FindFile( custom_SConscript, "." ):
        SConscript( custom_SConscript )

    
# Don't add libs until after xtfs_send_custom.SConscript and dependency SConscripts, to avoid failing build_conf checks because of missing -l libs
...
AlwaysBuild( build_env.Program( r"../../../../../bin/xtfs_send", (
r"../../../../../src/org/xtreemfs/client/bin/xtfs_send.cpp"
) ) )
