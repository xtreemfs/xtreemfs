...
namespace org
{
  namespace xtreemfs
  {
    namespace interfaces
    {
      ...
      #ifndef ORG_XTREEMFS_INTERFACES_MRCINTERFACE_PARENT_CLASS
      #if defined( ORG_XTREEMFS_INTERFACES_PARENT_CLASS )
      #define ORG_XTREEMFS_INTERFACES_MRCINTERFACE_PARENT_CLASS ORG_XTREEMFS_INTERFACES_PARENT_CLASS
      #elif defined( ORG_XTREEMFS_PARENT_CLASS )
      #define ORG_XTREEMFS_INTERFACES_MRCINTERFACE_PARENT_CLASS ORG_XTREEMFS_PARENT_CLASS
      #elif defined( ORG_PARENT_CLASS )
      #define ORG_XTREEMFS_INTERFACES_MRCINTERFACE_PARENT_CLASS ORG_PARENT_CLASS
      #else
      #define ORG_XTREEMFS_INTERFACES_MRCINTERFACE_PARENT_CLASS YIELD::EventHandler
      #endif
      #endif
      ...
      class MRCInterface : public ORG_XTREEMFS_INTERFACES_MRCINTERFACE_PARENT_CLASS
      {
      public:
        MRCInterface() { }
