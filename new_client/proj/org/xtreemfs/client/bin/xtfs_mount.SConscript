...
for custom_SConscript in ["xtfs_mount_custom.SConscript"]:
    if FindFile( custom_SConscript, "." ):
        SConscript( custom_SConscript )

    
# Don't add libs until after xtfs_mount_custom.SConscript and dependency SConscripts, to avoid failing build_conf checks because of missing -l libs
...
r"../../../../../src/org/xtreemfs/client/bin/xtfs_mount.cpp"
) ) )
