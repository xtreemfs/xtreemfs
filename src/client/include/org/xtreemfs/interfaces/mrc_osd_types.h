  ...
  namespace xtreemfs
  {
    namespace interfaces
    {
      ...
      public:
        ...
        // YIELD::Object
        void marshal( YIELD::Marshaller& marshaller ) const { marshaller.write( YIELD::Marshaller::Declaration( "size_in_bytes" ), size_in_bytes ); marshaller.write( YIELD::Marshaller::Declaration( "truncate_epoch" ), truncate_epoch ); }
      ...
      public:
        ...
        // YIELD::Object
        void marshal( YIELD::Marshaller& marshaller ) const { marshaller.write( YIELD::Marshaller::Declaration( "caching_policy" ), caching_policy ); marshaller.write( YIELD::Marshaller::Declaration( "data" ), data ); }
      ...
      public:
        ...
        // YIELD::Object
        void marshal( YIELD::Marshaller& marshaller ) const { marshaller.write( YIELD::Marshaller::Declaration( "new_file_size" ), new_file_size ); marshaller.write( YIELD::Marshaller::Declaration( "opaque_data" ), opaque_data ); }
      ...
      public:
        ...
        // YIELD::Object
        void marshal( YIELD::Marshaller& marshaller ) const { marshaller.write( YIELD::Marshaller::Declaration( "type" ), static_cast<int32_t>( type ) ); marshaller.write( YIELD::Marshaller::Declaration( "stripe_size" ), stripe_size ); marshaller.write( YIELD::Marshaller::Declaration( "width" ), width ); }
      ...
      public:
        ...
        // YIELD::Object
        void marshal( YIELD::Marshaller& marshaller ) const { marshaller.write( YIELD::Marshaller::Declaration( "striping_policy" ), striping_policy ); marshaller.write( YIELD::Marshaller::Declaration( "replication_flags" ), replication_flags ); marshaller.write( YIELD::Marshaller::Declaration( "osd_uuids" ), osd_uuids ); }
      ...
      public:
        ...
        // YIELD::Object
        void marshal( YIELD::Marshaller& marshaller ) const { marshaller.write( YIELD::Marshaller::Declaration( "file_id" ), file_id ); marshaller.write( YIELD::Marshaller::Declaration( "access_mode" ), access_mode ); marshaller.write( YIELD::Marshaller::Declaration( "expires_s" ), expires_s ); marshaller.write( YIELD::Marshaller::Declaration( "client_identity" ), client_identity ); marshaller.write( YIELD::Marshaller::Declaration( "truncate_epoch" ), truncate_epoch ); marshaller.write( YIELD::Marshaller::Declaration( "server_signature" ), server_signature ); }
      ...
      public:
        ...
        // YIELD::Object
        void marshal( YIELD::Marshaller& marshaller ) const { marshaller.write( YIELD::Marshaller::Declaration( "replicas" ), replicas ); marshaller.write( YIELD::Marshaller::Declaration( "version" ), version ); marshaller.write( YIELD::Marshaller::Declaration( "repUpdatePolicy" ), repUpdatePolicy ); marshaller.write( YIELD::Marshaller::Declaration( "read_only_file_size" ), read_only_file_size ); }
      ...
      public:
        ...
        // YIELD::Object
        void marshal( YIELD::Marshaller& marshaller ) const { marshaller.write( YIELD::Marshaller::Declaration( "xlocs" ), xlocs ); marshaller.write( YIELD::Marshaller::Declaration( "xcap" ), xcap ); }
