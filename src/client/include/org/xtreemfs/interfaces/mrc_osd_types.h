  ...
  namespace xtreemfs
  {
    namespace interfaces
    {
      ...
      public:
        ...
        // YIELD::Object
        void marshal( YIELD::Marshaller& marshaller ) const { marshaller.writeUint64( YIELD::Marshaller::Declaration( "size_in_bytes" ), size_in_bytes ); marshaller.writeUint32( YIELD::Marshaller::Declaration( "truncate_epoch" ), truncate_epoch ); }
      ...
      public:
        ...
        // YIELD::Object
        void marshal( YIELD::Marshaller& marshaller ) const { marshaller.writeUint8( YIELD::Marshaller::Declaration( "caching_policy" ), caching_policy ); marshaller.writeString( YIELD::Marshaller::Declaration( "data" ), data ); }
      ...
      public:
        ...
        // YIELD::Object
        void marshal( YIELD::Marshaller& marshaller ) const { marshaller.writeSequence( YIELD::Marshaller::Declaration( "new_file_size" ), new_file_size ); marshaller.writeSequence( YIELD::Marshaller::Declaration( "opaque_data" ), opaque_data ); }
      ...
      public:
        ...
        // YIELD::Object
        void marshal( YIELD::Marshaller& marshaller ) const { marshaller.writeInt32( YIELD::Marshaller::Declaration( "type" ), static_cast<int32_t>( type ) ); marshaller.writeUint32( YIELD::Marshaller::Declaration( "stripe_size" ), stripe_size ); marshaller.writeUint32( YIELD::Marshaller::Declaration( "width" ), width ); }
      ...
      public:
        ...
        // YIELD::Object
        void marshal( YIELD::Marshaller& marshaller ) const { marshaller.writeStruct( YIELD::Marshaller::Declaration( "striping_policy" ), striping_policy ); marshaller.writeUint32( YIELD::Marshaller::Declaration( "replication_flags" ), replication_flags ); marshaller.writeSequence( YIELD::Marshaller::Declaration( "osd_uuids" ), osd_uuids ); }
      ...
      public:
        ...
        // YIELD::Object
        void marshal( YIELD::Marshaller& marshaller ) const { marshaller.writeString( YIELD::Marshaller::Declaration( "file_id" ), file_id ); marshaller.writeUint32( YIELD::Marshaller::Declaration( "access_mode" ), access_mode ); marshaller.writeUint64( YIELD::Marshaller::Declaration( "expires_s" ), expires_s ); marshaller.writeString( YIELD::Marshaller::Declaration( "client_identity" ), client_identity ); marshaller.writeUint32( YIELD::Marshaller::Declaration( "truncate_epoch" ), truncate_epoch ); marshaller.writeString( YIELD::Marshaller::Declaration( "server_signature" ), server_signature ); }
      ...
      public:
        ...
        // YIELD::Object
        void marshal( YIELD::Marshaller& marshaller ) const { marshaller.writeSequence( YIELD::Marshaller::Declaration( "replicas" ), replicas ); marshaller.writeUint32( YIELD::Marshaller::Declaration( "version" ), version ); marshaller.writeString( YIELD::Marshaller::Declaration( "repUpdatePolicy" ), repUpdatePolicy ); marshaller.writeUint64( YIELD::Marshaller::Declaration( "read_only_file_size" ), read_only_file_size ); }
      ...
      public:
        ...
        // YIELD::Object
        void marshal( YIELD::Marshaller& marshaller ) const { marshaller.writeStruct( YIELD::Marshaller::Declaration( "xlocs" ), xlocs ); marshaller.writeStruct( YIELD::Marshaller::Declaration( "xcap" ), xcap ); }
