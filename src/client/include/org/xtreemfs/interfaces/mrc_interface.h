  ...
  namespace xtreemfs
  {
    namespace interfaces
    {
      ...
      const static uint32_t DEFAULT_HTTP_PORT = 30636;
        ...
        virtual void chown( const std::string& path, const std::string& user_id, const std::string& group_id, uint64_t response_timeout_ns ) { ::YIELD::auto_Object<chownRequest> __request( new chownRequest( path, user_id, group_id ) ); ::YIELD::auto_EventQueue __response_queue( new ::YIELD::EventQueue ); __request->set_response_target( __response_queue->incRef() ); send( __request->incRef() ); ::YIELD::auto_Object<chownResponse> __response = __response_queue->dequeue_typed<chownResponse>( response_timeout_ns ); }

        virtual void creat( const std::string& path, uint32_t mode ) { creat( path, mode, static_cast<uint64_t>( -1 ) ); }
        virtual void creat( const std::string& path, uint32_t mode, uint64_t response_timeout_ns ) { ::YIELD::auto_Object<creatRequest> __request( new creatRequest( path, mode ) ); ::YIELD::auto_EventQueue __response_queue( new ::YIELD::EventQueue ); __request->set_response_target( __response_queue->incRef() ); send( __request->incRef() ); ::YIELD::auto_Object<creatResponse> __response = __response_queue->dequeue_typed<creatResponse>( response_timeout_ns ); }
        ...
        virtual void link( const std::string& target_path, const std::string& link_path, uint64_t response_timeout_ns ) { ::YIELD::auto_Object<linkRequest> __request( new linkRequest( target_path, link_path ) ); ::YIELD::auto_EventQueue __response_queue( new ::YIELD::EventQueue ); __request->set_response_target( __response_queue->incRef() ); send( __request->incRef() ); ::YIELD::auto_Object<linkResponse> __response = __response_queue->dequeue_typed<linkResponse>( response_timeout_ns ); }
        ...
        virtual void xtreemfs_dump_database( const std::string& dump_file, uint64_t response_timeout_ns ) { ::YIELD::auto_Object<xtreemfs_dump_databaseRequest> __request( new xtreemfs_dump_databaseRequest( dump_file ) ); ::YIELD::auto_EventQueue __response_queue( new ::YIELD::EventQueue ); __request->set_response_target( __response_queue->incRef() ); send( __request->incRef() ); ::YIELD::auto_Object<xtreemfs_dump_databaseResponse> __response = __response_queue->dequeue_typed<xtreemfs_dump_databaseResponse>( response_timeout_ns ); }
        ...
        virtual void xtreemfs_internal_debug( const std::string& operation, std::string& result, uint64_t response_timeout_ns ) { ::YIELD::auto_Object<xtreemfs_internal_debugRequest> __request( new xtreemfs_internal_debugRequest( operation ) ); ::YIELD::auto_EventQueue __response_queue( new ::YIELD::EventQueue ); __request->set_response_target( __response_queue->incRef() ); send( __request->incRef() ); ::YIELD::auto_Object<xtreemfs_internal_debugResponse> __response = __response_queue->dequeue_typed<xtreemfs_internal_debugResponse>( response_timeout_ns ); result = __response->get_result(); }
        ...
        virtual void xtreemfs_replica_add( const std::string& file_id, const org::xtreemfs::interfaces::Replica& new_replica, uint64_t response_timeout_ns ) { ::YIELD::auto_Object<xtreemfs_replica_addRequest> __request( new xtreemfs_replica_addRequest( file_id, new_replica ) ); ::YIELD::auto_EventQueue __response_queue( new ::YIELD::EventQueue ); __request->set_response_target( __response_queue->incRef() ); send( __request->incRef() ); ::YIELD::auto_Object<xtreemfs_replica_addResponse> __response = __response_queue->dequeue_typed<xtreemfs_replica_addResponse>( response_timeout_ns ); }
        ...
        virtual void xtreemfs_restore_file( const std::string& file_path, const std::string& file_id, uint64_t file_size, const std::string& osd_uuid, int32_t stripe_size, uint64_t response_timeout_ns ) { ::YIELD::auto_Object<xtreemfs_restore_fileRequest> __request( new xtreemfs_restore_fileRequest( file_path, file_id, file_size, osd_uuid, stripe_size ) ); ::YIELD::auto_EventQueue __response_queue( new ::YIELD::EventQueue ); __request->set_response_target( __response_queue->incRef() ); send( __request->incRef() ); ::YIELD::auto_Object<xtreemfs_restore_fileResponse> __response = __response_queue->dequeue_typed<xtreemfs_restore_fileResponse>( response_timeout_ns ); }
