  ...
  namespace xtreemfs
  {
    namespace client
    {
      ...
      public:
        ...
        Volume( const YIELD::URI& dir_uri, const std::string& name, YIELD::auto_Object<YIELD::SocketFactory> socket_factory = NULL, uint32_t flags = 0, YIELD::auto_Object<YIELD::Log> log = NULL );
