  ...
  namespace xtreemfs
  {
    namespace client
    {
      ...
      public:
        ...
        {
          return ONCRPCClient<org::xtreemfs::interfaces::OSDInterface>::create<OSDProxy>( absolute_uri, stage_group, log, operation_timeout, reconnect_tries_max, ssl_context );
        }
