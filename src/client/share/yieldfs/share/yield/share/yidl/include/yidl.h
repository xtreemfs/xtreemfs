...
#define YIDL_OBJECT_PROTOTYPES( type_name, type_id ) \
    type_name & incRef() { return ::yidl::Object::incRef( *this ); } \
...
#define YIDL_OBJECT_TYPE_ID( type ) type::__type_id
...
namespace yidl
{
  ...
  public:
    ...
    // Object
    YIDL_OBJECT_PROTOTYPES( FixedBuffer, 2 );
  ...
  public:
    ...
    // Object
    YIDL_OBJECT_PROTOTYPES( HeapBuffer, 4 );
  };
...
#define YIDL_MARSHALLER_PROTOTYPES \
  ...
  virtual void writeBuffer( const char* key, uint32_t tag, yidl::auto_Buffer value ); \
  ...
  virtual void writeMap( const char* key, uint32_t tag, const yidl::Map& value ); \
  virtual void writeSequence( const char* key, uint32_t tag, const yidl::Sequence& value ); \
  virtual void writeString( const char* key, uint32_t tag, const char* value, size_t value_len ); \
  virtual void writeStruct( const char* key, uint32_t tag, const yidl::Struct& value );
  ...
  public:
    ...
    // Object
    YIDL_OBJECT_PROTOTYPES( StackBuffer, 5 );
  ...
  public:
    ...
    // Object
    YIDL_OBJECT_PROTOTYPES( StringBuffer, 6 );
  ...
  public:
    ...
    // Object
    YIDL_OBJECT_PROTOTYPES( StringLiteralBuffer, 7 );
...
#define YIDL_UNMARSHALLER_PROTOTYPES \
  ...
  virtual void readBuffer( const char* key, uint32_t tag, yidl::auto_Buffer value ); \
  virtual double readDouble( const char* key, uint32_t tag ); \
  virtual int64_t readInt64( const char* key, uint32_t tag ); \
  virtual void readMap( const char* key, uint32_t tag, yidl::Map& value ); \
  virtual void readSequence( const char* key, uint32_t tag, yidl::Sequence& value ); \
  virtual void readString( const char* key, uint32_t tag, std::string& value ); \
  virtual void readStruct( const char* key, uint32_t tag, yidl::Struct& value );
};
#endif
