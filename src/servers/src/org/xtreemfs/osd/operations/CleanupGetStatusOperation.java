...
public final class CleanupGetStatusOperation extends OSDOperation {
    ...
    public CleanupGetStatusOperation(OSDRequestDispatcher master) {
        super(master);
        procId = xtreemfs_cleanup_statusRequest.TAG;
    }
    ...
    public void startRequest(final OSDRequest rq) {
        ...
        xtreemfs_cleanup_statusRequest args = (xtreemfs_cleanup_statusRequest)rq.getRequestArgs();
        xtreemfs_cleanup_statusResponse response = new xtreemfs_cleanup_statusResponse(master.getCleanupThread().getStatus());
        rq.sendSuccess(response);
    }

    @Override
    public yidl.runtime.Object parseRPCMessage(ReusableBuffer data, OSDRequest rq) throws Exception {
        xtreemfs_cleanup_statusRequest rpcrq = new xtreemfs_cleanup_statusRequest();
