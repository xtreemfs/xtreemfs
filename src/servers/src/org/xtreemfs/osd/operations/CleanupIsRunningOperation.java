...
public final class CleanupIsRunningOperation extends OSDOperation {
    ...
    public void startRequest(final OSDRequest rq) {
        ...
        xtreemfs_cleanup_is_runningRequest args = (xtreemfs_cleanup_is_runningRequest)rq.getRequestArgs();
        xtreemfs_cleanup_is_runningResponse response = new xtreemfs_cleanup_is_runningResponse(master.getCleanupThread().isRunning());
