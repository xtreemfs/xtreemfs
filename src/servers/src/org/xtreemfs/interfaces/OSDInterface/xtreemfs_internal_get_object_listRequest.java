...
public class xtreemfs_internal_get_object_listRequest implements org.xtreemfs.interfaces.utils.Request
{
    ...
    public xtreemfs_internal_get_object_listRequest() { file_credentials = new FileCredentials(); file_id = ""; }
    public xtreemfs_internal_get_object_listRequest( FileCredentials file_credentials, String file_id ) { this.file_credentials = file_credentials; this.file_id = file_id; }
    public xtreemfs_internal_get_object_listRequest( Object from_hash_map ) { file_credentials = new FileCredentials(); file_id = ""; this.deserialize( from_hash_map ); }
    public xtreemfs_internal_get_object_listRequest( Object[] from_array ) { file_credentials = new FileCredentials(); file_id = "";this.deserialize( from_array ); }
    ...
    {
        return "xtreemfs_internal_get_object_listRequest( " + file_credentials.toString() + ", " + "\"" + file_id + "\"" + " )";
    }
