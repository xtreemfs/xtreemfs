...
{
    public static final int TAG = 2010011951;
    
    public Stat() {  }
    public Stat( long dev, long ino, int mode, int nlink, int uid, int gid, long size, long atime_ns, long mtime_ns, long ctime_ns, int blksize, String user_id, String group_id, int truncate_epoch, int attributes ) { this.dev = dev; this.ino = ino; this.mode = mode; this.nlink = nlink; this.uid = uid; this.gid = gid; this.size = size; this.atime_ns = atime_ns; this.mtime_ns = mtime_ns; this.ctime_ns = ctime_ns; this.blksize = blksize; this.user_id = user_id; this.group_id = group_id; this.truncate_epoch = truncate_epoch; this.attributes = attributes; }
    ...
    public static final long serialVersionUID = 2010011951;    

    // yidl.runtime.Object
    public int getTag() { return 2010011951; }
