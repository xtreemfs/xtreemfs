...
{
    public static final int TAG = 2009120950;
    
    public Stat() {  }
    public Stat( long dev, long ino, int mode, int nlink, int uid, int gid, int unused_dev, long size, int blksize, long atime_ns, long mtime_ns, long ctime_ns, String file_id, String user_id, String group_id, String link_target, int truncate_epoch, int attributes ) { this.dev = dev; this.ino = ino; this.mode = mode; this.nlink = nlink; this.uid = uid; this.gid = gid; this.unused_dev = unused_dev; this.size = size; this.blksize = blksize; this.atime_ns = atime_ns; this.mtime_ns = mtime_ns; this.ctime_ns = ctime_ns; this.file_id = file_id; this.user_id = user_id; this.group_id = group_id; this.link_target = link_target; this.truncate_epoch = truncate_epoch; this.attributes = attributes; }
    ...
    public static final long serialVersionUID = 2009120950;    

    // yidl.runtime.Object
    public int getTag() { return 2009120950; }
