...
public class listxattrRequest extends org.xtreemfs.foundation.oncrpc.utils.Request
{
    public static final int TAG = 2010031123;

    public listxattrRequest() {  }
    public listxattrRequest( String volume_name, String path ) { this.volume_name = volume_name; this.path = path; }
