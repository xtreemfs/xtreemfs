...
{
    public static final int TAG = 2010030525;

    public readlinkRequest() {  }
    public readlinkRequest( String volume_name, String path ) { this.volume_name = volume_name; this.path = path; }
    ...
    public static final long serialVersionUID = 2010030525;

    // yidl.runtime.Object
    public int getTag() { return 2010030525; }
