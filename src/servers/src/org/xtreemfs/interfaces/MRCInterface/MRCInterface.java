...
public class MRCInterface
{
    ...
    public static Request createRequest( ONCRPCRequestHeader header ) throws Exception
    {
        switch( header.getProcedure() )
        {
            ...
            case 1204: return new createRequest();
    ...
    public static Response createResponse( ONCRPCResponseHeader header ) throws Exception
    {
        ...
        {
            case 1201: return new accessResponse();            case 1202: return new chmodResponse();            case 1203: return new chownResponse();            case 1204: return new createResponse();            case 1230: return new ftruncateResponse();            case 1205: return new getattrResponse();            case 1206: return new getxattrResponse();            case 1207: return new linkResponse();            case 1208: return new listxattrResponse();            case 1209: return new mkdirResponse();            case 1211: return new openResponse();            case 1212: return new readdirResponse();            case 1213: return new removexattrResponse();            case 1214: return new renameResponse();            case 1215: return new rmdirResponse();            case 1217: return new setattrResponse();            case 1218: return new setxattrResponse();            case 1219: return new statvfsResponse();            case 1220: return new symlinkResponse();            case 1221: return new unlinkResponse();            case 1222: return new utimensResponse();            case 1251: return new xtreemfs_checkpointResponse();            case 1223: return new xtreemfs_check_file_existsResponse();            case 1252: return new xtreemfs_dump_databaseResponse();            case 1224: return new xtreemfs_get_suitable_osdsResponse();            case 1254: return new xtreemfs_internal_debugResponse();            case 1231: return new xtreemfs_lsvolResponse();            case 1233: return new xtreemfs_listdirResponse();            case 1210: return new xtreemfs_mkvolResponse();            case 1225: return new xtreemfs_renew_capabilityResponse();            case 1226: return new xtreemfs_replica_addResponse();            case 1232: return new xtreemfs_replica_listResponse();            case 1227: return new xtreemfs_replica_removeResponse();            case 1253: return new xtreemfs_restore_databaseResponse();            case 1228: return new xtreemfs_restore_fileResponse();            case 1216: return new xtreemfs_rmvolResponse();            case 1250: return new xtreemfs_shutdownResponse();            case 1229: return new xtreemfs_update_file_sizeResponse();
