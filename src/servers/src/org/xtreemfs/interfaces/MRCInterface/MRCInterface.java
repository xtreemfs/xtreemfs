...
public class MRCInterface
{
    ...
    public static final int DEFAULT_ONCRPCU_PORT = 32636;
    ...
    public static Request createRequest( ONCRPCRequestHeader header ) throws Exception
    {
        switch( header.getProcedure() )
        {
            ...
            case 2009090448: return new xtreemfs_replication_to_masterRequest();
            case 2009090449: return new xtreemfs_replica_addRequest();
            case 2009090450: return new xtreemfs_replica_listRequest();
            case 2009090451: return new xtreemfs_replica_removeRequest();
            case 2009090452: return new xtreemfs_restore_databaseRequest();
            case 2009090453: return new xtreemfs_restore_fileRequest();
            case 2009090454: return new xtreemfs_rmvolRequest();
            case 2009090455: return new xtreemfs_shutdownRequest();
            case 2009090456: return new xtreemfs_update_file_sizeRequest();
