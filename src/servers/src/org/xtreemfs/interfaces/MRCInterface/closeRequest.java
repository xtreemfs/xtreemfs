...
public class closeRequest implements org.xtreemfs.interfaces.utils.Request
{
    ...
    public closeRequest( Object from_hash_map ) { write_xcap = new XCap(); this.deserialize( from_hash_map ); }
    public closeRequest( Object[] from_array ) { write_xcap = new XCap();this.deserialize( from_array ); }
    ...
    {
        return "closeRequest( " + write_xcap.toString() + " )";
    }
