...
public class symlinkRequest extends org.xtreemfs.foundation.oncrpc.utils.Request
{
    public static final int TAG = 2010031134;

    public symlinkRequest() {  }
    public symlinkRequest( String volume_name, String target_path, String link_path ) { this.volume_name = volume_name; this.target_path = target_path; this.link_path = link_path; }
    ...
    public static final long serialVersionUID = 2010031134;

    // yidl.runtime.Object
    public int getTag() { return 2010031134; }
