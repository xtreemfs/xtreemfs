...
public class xtreemfs_address_mappings_getResponse implements org.xtreemfs.interfaces.utils.Response
{
    ...
    public xtreemfs_address_mappings_getResponse( Object from_hash_map ) { address_mappings = new AddressMappingSet(); this.deserialize( from_hash_map ); }
    public xtreemfs_address_mappings_getResponse( Object[] from_array ) { address_mappings = new AddressMappingSet();this.deserialize( from_array ); }
    ...
    {
        return "xtreemfs_address_mappings_getResponse( " + address_mappings.toString() + " )";
    }
