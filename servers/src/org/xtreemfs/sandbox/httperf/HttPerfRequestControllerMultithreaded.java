 ...
 *
 * Created on December 22, 2007, 15:28 PM
 *
...
public class HttPerfRequestControllerMultithreaded {
...
// * methods are called
// */
//public class HttPerfRequestControllerMultithreaded implements PinkyRequestListener, RequestHandler, UDPCom {
//
//    // Stages of OSD
...
//    private final MultithreadedStorageStage        stStorage;
//
...
//     */
//    public HttPerfRequestControllerMultithreaded(OSDConfig config, OSDId me) throws IOException {
//
//        this.me = me;
//        this.config = config;
//
...
//        stStorage = new MultithreadedStorageStage(this, this, config, stSpeedy,10);
...
//     */
//    public MultithreadedStorageStage getStorage() {
//        return stStorage;
//    }
//
