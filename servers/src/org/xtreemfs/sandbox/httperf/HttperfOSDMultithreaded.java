 ...
 * Main.java
 *
 * HttPerfRequestControllerMultithreaded.java
 *
 * Created on December 22, 2007, 17:03 PM
 *
...
public class HttperfOSDMultithreaded {


//    private HttPerfRequestControllerMultithreaded controller;
//
...
//     */
//    public HttperfOSDMultithreaded(OSDConfig config, OSDId me, boolean dirServiceInUse) {
//        try {
...
//            controller = new HttPerfRequestControllerMultithreaded(config,me);
//			controller.start();
//
//            if (dirServiceInUse) {
...
//    }
//
//    public HttPerfRequestControllerMultithreaded getController() {
//        return controller;
//    }
//
//    /**
...
//
//        new HttperfOSDMultithreaded(config,new OSDId(me, OSDId.SCHEME_HTTP), true);
//    }
//
...
//            try {
//                //deregister old data
//                RPCResponse r = client.deregisterEntity(uuid,"nullauth bla");
//                r.waitForResponse();
//                r.freeBuffers();
//            } catch (Exception ex) {
//                ex.printStackTrace();
...
//                        RPCResponse response = client.registerEntity(uuid, RPCClient.generateMap("uuid",uuid,"type","OSD","free","1000000"), "nullauth bla");
...
//                    } else {
//                        // update the timestamp
//                        RPCResponse response = client.registerEntity(uuid, new HashMap<String, Object>(), "nullauth bla");
//                        response.waitForResponse();
//                        response.freeBuffers();
