...
/**
 * Selects OSDs according to their DNS names matching the client's
 * name. The OSDs are sorting according to the number of characters that
 * match in both names (starting from the last character).
 *
 * @author bjko
 */
public class DNSSelectionPolicy extends AbstractSelectionPolicy {

    public static final short POLICY_ID = (short) OSDSelectionPolicyType.OSD_SELECTION_POLICY_DNS
                                                .intValue();
