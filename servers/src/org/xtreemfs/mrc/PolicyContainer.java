...
public class PolicyContainer {
    ...
    public FileAccessPolicy getFileAccessPolicy(long id, SliceManager sliceMan) throws Exception {
        ...
        try {
            return (FileAccessPolicy) policyClass
                    .getConstructor(new Class[] { SliceManager.class }).newInstance(sliceMan);
        } catch (InstantiationException exc) {
            // ignore
        }
