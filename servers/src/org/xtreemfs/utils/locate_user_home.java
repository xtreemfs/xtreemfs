    ...
    public static void main(String[] args) {
        try {
            ...
            if (arguments.size() != 1) {
                ...
                System.out.println("");
                System.out.println("This utility will return the first matching volume URL and an exit status 0 on success. "+
            ...
            if (dirUrl == null) {
                ...
                if (!defaultDir.exists()) {
                    ...
                    if (c.isSslEnabled()) {
                        sslopts = new SSLOptions(c.getServiceCredsFile(), c.getServiceCredsPassphrase(), 
                                c.getServiceCredsContainer(),c.getTrustedCertsFile(), c.getTrustedCertsPassphrase(),
                                c.getTrustedCertsContainer(),false);
                    }
                }
            } else {
            ...
            String volURL = dir.locateUserHome(arguments.get(0), NullAuthProvider.createAuthString("locate_user_home", "utils"));
            dir.shutdown();
