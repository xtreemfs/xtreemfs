...
public class MessageUtils {
    ...
    public static void marshallResponse(DIRRequest req, Object res) {
    ...
    public static void marshallResponse(DIRRequest req, Object res, HTTPHeaders additionalHeaders) {
    ...
    public static void marshallException(DIRRequest req, Map<String, Object> excMap,
    ...
    public static void marshallException(DIRRequest req, Throwable exc) {
    ...
    public static void setRedirect(DIRRequest req, String target) {
    ...
    public static Object unmarshallRequestOld(DIRRequest request) throws JSONException {
        String body = null;
    ...
    public static Object unmarshallRequest(DIRRequest request) throws JSONException {
        String body = null;
