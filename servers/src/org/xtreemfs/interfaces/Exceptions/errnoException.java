...
public class errnoException extends org.xtreemfs.interfaces.utils.ONCRPCException
{
    ...
    public errnoException( Object from_hash_map ) { error_code = 0; errro_message = ""; stack_trace = ""; this.deserialize( from_hash_map ); }
    public errnoException( Object[] from_array ) { error_code = 0; errro_message = ""; stack_trace = "";this.deserialize( from_array ); }
