...
{
    public unlinkRequest() { file_id = ""; credentials = new org.xtreemfs.interfaces.FileCredentials(); }
    ...
    // Serializable
    public String getTypeName() { return "xtreemfs::interfaces::OSDInterface::unlinkRequest"; }    
