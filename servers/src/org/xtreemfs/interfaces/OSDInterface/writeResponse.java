...
{
    public writeResponse() { osd_response = new org.xtreemfs.interfaces.OSDWriteResponse(); }
    ...
    // Serializable
    public String getTypeName() { return "xtreemfs::interfaces::OSDInterface::writeResponse"; }    
