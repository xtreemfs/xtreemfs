...
{
    public truncateRequest() { file_id = ""; credentials = new org.xtreemfs.interfaces.FileCredentials(); new_file_size = 0; }
    ...
    // Serializable
    public String getTypeName() { return "xtreemfs::interfaces::OSDInterface::truncateRequest"; }    
