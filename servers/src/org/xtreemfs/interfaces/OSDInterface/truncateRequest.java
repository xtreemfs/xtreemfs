...
public class truncateRequest implements org.xtreemfs.interfaces.utils.Request
{
    public truncateRequest() { file_id = ""; credentials = new FileCredentials(); new_file_size = 0; }
    public truncateRequest( String file_id, FileCredentials credentials, long new_file_size ) { this.file_id = file_id; this.credentials = credentials; this.new_file_size = new_file_size; }
    public truncateRequest( Object from_hash_map ) { file_id = ""; credentials = new FileCredentials(); new_file_size = 0; this.deserialize( from_hash_map ); }
    public truncateRequest( Object[] from_array ) { file_id = ""; credentials = new FileCredentials(); new_file_size = 0;this.deserialize( from_array ); }
