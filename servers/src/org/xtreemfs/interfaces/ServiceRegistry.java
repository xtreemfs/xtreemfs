...
{
    public ServiceRegistry() { uuid = ""; version = 0; service_type = 0; data = new org.xtreemfs.interfaces.KeyValuePairSet(); }
    public ServiceRegistry( String uuid, long version, int service_type, KeyValuePairSet data ) { this.uuid = uuid; this.version = version; this.service_type = service_type; this.data = data; }
    ...
    {
        return "ServiceRegistry( " + "\"" + uuid + "\"" + ", " + Long.toString( version ) + ", " + Integer.toString( service_type ) + ", " + data.toString() + " )";
    }    
