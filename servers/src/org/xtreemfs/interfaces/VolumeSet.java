...
public class VolumeSet extends ArrayList<Volume>
{

    public VolumeSet()
    { }

    public VolumeSet( Object from_array )
    {
    ...
    public void deserialize( Object[] from_array )
    {
        for ( int from_array_i = 0; from_array_i < from_array.length; from_array_i++ )
            this.add( new Volume( from_array[from_array_i] ) );
    }        
    ...
    if (new_size > org.xtreemfs.interfaces.utils.XDRUtils.MAX_ARRAY_ELEMS)
        ...
        {
            Volume new_value; new_value = new Volume(); new_value.deserialize( buf );;
            this.add( new_value );
        }
    } 
