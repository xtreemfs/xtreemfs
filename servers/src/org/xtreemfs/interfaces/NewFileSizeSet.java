...
{    
    // Serializable
    public String getTypeName() { return "xtreemfs::interfaces::NewFileSizeSet"; }
	...
	if (new_size > org.xtreemfs.interfaces.utils.XDRUtils.MAX_ARRAY_ELEMS)
        ...
        {
            NewFileSize new_value; new_value = new org.xtreemfs.interfaces.NewFileSize(); new_value.deserialize( buf );;
            this.add( new_value );
        }
    }
