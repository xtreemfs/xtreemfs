...
public class removexattrRequest implements Request
{
    public removexattrRequest() { context = new org.xtreemfs.interfaces.Context(); path = ""; name = ""; }
    ...
    {
        return "removexattrRequest( " + context.toString() + ", " + "\"" + path + "\"" + ", " + "\"" + name + "\"" + " )";
    }    

    // Serializable
    public String getTypeName() { return "xtreemfs::interfaces::MRCInterface::removexattrRequest"; }    
