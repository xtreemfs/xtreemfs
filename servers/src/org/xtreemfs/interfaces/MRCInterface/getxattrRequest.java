...
{
    public getxattrRequest() { context = new Context(); path = ""; name = ""; }
    public getxattrRequest( Context context, String path, String name ) { this.context = context; this.path = path; this.name = name; }
    public getxattrRequest( Object from_hash_map ) { context = new Context(); path = ""; name = ""; this.deserialize( from_hash_map ); }
    public getxattrRequest( Object[] from_array ) { context = new Context(); path = ""; name = "";this.deserialize( from_array ); }
