...
public class admin_restore_databaseRequest implements org.xtreemfs.interfaces.utils.Request
{
    ...
    public admin_restore_databaseRequest( Object from_hash_map ) { password = ""; dump_file = ""; this.deserialize( from_hash_map ); }
    public admin_restore_databaseRequest( Object[] from_array ) { password = ""; dump_file = "";this.deserialize( from_array ); }
    ...
    // Serializable
    public String getTypeName() { return "org::xtreemfs::interfaces::MRCInterface::admin_restore_databaseRequest"; }    
