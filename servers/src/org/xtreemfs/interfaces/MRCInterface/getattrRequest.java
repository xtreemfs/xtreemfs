...
public class getattrRequest implements Request
{
    public getattrRequest() { context = new org.xtreemfs.interfaces.Context(); path = ""; }
    ...
    // Serializable
    public String getTypeName() { return "xtreemfs::interfaces::MRCInterface::getattrRequest"; }    
