...
public class admin_dump_databaseRequest implements Request
{
    ...
    // Serializable
    public String getTypeName() { return "xtreemfs::interfaces::MRCInterface::admin_dump_databaseRequest"; }    
