...
public class listxattrRequest implements Request
{
    public listxattrRequest() { context = new org.xtreemfs.interfaces.Context(); path = ""; }
    ...
    // Serializable
    public String getTypeName() { return "xtreemfs::interfaces::MRCInterface::listxattrRequest"; }    
