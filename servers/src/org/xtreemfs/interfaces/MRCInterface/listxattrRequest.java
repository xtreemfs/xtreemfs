...
{
    public listxattrRequest() { context = new Context(); path = ""; }
    public listxattrRequest( Context context, String path ) { this.context = context; this.path = path; }
    public listxattrRequest( Object from_hash_map ) { context = new Context(); path = ""; this.deserialize( from_hash_map ); }
    public listxattrRequest( Object[] from_array ) { context = new Context(); path = "";this.deserialize( from_array ); }
