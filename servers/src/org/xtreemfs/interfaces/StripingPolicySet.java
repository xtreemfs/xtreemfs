...
{    
    // Serializable
    public String getTypeName() { return "xtreemfs::interfaces::StripingPolicySet"; }
	...
	if (new_size > org.xtreemfs.interfaces.utils.XDRUtils.MAX_ARRAY_ELEMS)
        ...
        {
            StripingPolicy new_value; new_value = new org.xtreemfs.interfaces.StripingPolicy(); new_value.deserialize( buf );;
            this.add( new_value );
        }
    }
