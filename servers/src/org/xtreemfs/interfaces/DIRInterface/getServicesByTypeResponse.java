...
public class getServicesByTypeResponse implements Response
{
    public getServicesByTypeResponse() { services = new org.xtreemfs.interfaces.ServiceRegistrySet(); }
    public getServicesByTypeResponse( ServiceRegistrySet services ) { this.services = services; }
    ...
    {
        return "getServicesByTypeResponse( " + services.toString() + " )";
    }    

    // Serializable
    public String getTypeName() { return "xtreemfs::interfaces::DIRInterface::getServicesByTypeResponse"; }    
