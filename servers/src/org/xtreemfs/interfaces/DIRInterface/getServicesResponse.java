...
public class getServicesResponse implements Response
{
    public getServicesResponse() { services = new org.xtreemfs.interfaces.ServiceRegistrySet(); }
    public getServicesResponse( ServiceRegistrySet services ) { this.services = services; }
    ...
    {
        return "getServicesResponse( " + services.toString() + " )";
    }    

    // Serializable
    public String getTypeName() { return "xtreemfs::interfaces::DIRInterface::getServicesResponse"; }    
