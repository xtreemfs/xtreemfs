...
public class admin_checkpointRequest implements org.xtreemfs.interfaces.utils.Request
{
    public admin_checkpointRequest() { password = ""; }
    public admin_checkpointRequest( String password ) { this.password = password; }
    public admin_checkpointRequest( Object from_hash_map ) { password = ""; this.deserialize( from_hash_map ); }
    public admin_checkpointRequest( Object[] from_array ) { password = "";this.deserialize( from_array ); }

    public String getPassword() { return password; }
    public void setPassword( String password ) { this.password = password; }

    public String getTypeName() { return "org::xtreemfs::interfaces::DIRInterface::admin_checkpointRequest"; }    
