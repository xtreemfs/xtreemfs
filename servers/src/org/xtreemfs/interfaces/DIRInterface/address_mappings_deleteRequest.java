...
public class address_mappings_deleteRequest implements org.xtreemfs.interfaces.utils.Request
{
    public address_mappings_deleteRequest() { uuid = ""; }
    public address_mappings_deleteRequest( String uuid ) { this.uuid = uuid; }
    public address_mappings_deleteRequest( Object from_hash_map ) { uuid = ""; this.deserialize( from_hash_map ); }
    public address_mappings_deleteRequest( Object[] from_array ) { uuid = "";this.deserialize( from_array ); }
