...
public class XCap implements Serializable
{
    ...
    public XCap( String file_id, long access_mode, long expires, String clientIdentity, long truncateEpoch, String serverSignature, String __json ) { this.file_id = file_id; this.access_mode = access_mode; this.expires = expires; this.clientIdentity = clientIdentity; this.truncateEpoch = truncateEpoch; this.serverSignature = serverSignature; this.__json = __json; }


    // Object
    public String toString()
    {
        return "XCap( " + "\"" + file_id + "\"" + ", " + Long.toString( access_mode ) + ", " + Long.toString( expires ) + ", " + "\"" + clientIdentity + "\"" + ", " + Long.toString( truncateEpoch ) + ", " + "\"" + serverSignature + "\"" + ", " + "\"" + __json + "\"" + " )";
    }    
    ...
    public long access_mode;
    public long expires;
    public String clientIdentity;
    public long truncateEpoch;
