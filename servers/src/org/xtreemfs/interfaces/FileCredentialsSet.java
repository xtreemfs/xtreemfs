...
public class FileCredentialsSet extends ArrayList<FileCredentials>
{
    ...
    public FileCredentialsSet( Object from_array )
    {
    ...
    public Object serialize() 
    {
        ...
        {
            FileCredentials next_value = super.get( value_i );                    
    ...
    public void deserialize( Object[] from_array )
    {
        for ( int from_array_i = 0; from_array_i < from_array.length; from_array_i++ )
            this.add( new FileCredentials( from_array[from_array_i] ) );
    }        
    ...
    if (new_size > org.xtreemfs.interfaces.utils.XDRUtils.MAX_ARRAY_ELEMS)
        ...
        {
            FileCredentials new_value; new_value = new FileCredentials(); new_value.deserialize( buf );;
            this.add( new_value );
        }
    } 
