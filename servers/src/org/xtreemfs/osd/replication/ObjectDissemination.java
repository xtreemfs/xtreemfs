...
public class ObjectDissemination {
	...
	/**
	 * files which are downloaded, maybe in background (without an actual
	 * request) key: fileID
	 */
	...
	public void fetchObject(OSDRequest rq) {
		...
		rqDetails.getReplicationTransfer().addRequiredObject(
	...
	private void prepareRequest(OSDRequest rq) {
		...
		// if a original OSDRequest is waiting for this object, attach it to the
		// request, which should fetch it
