 ...
 * @author bjko
 */
public class ReturnLease extends Operation {

    public ReturnLease(OSDRequestDispatcher master) {
        super(master);
    }
    ...
    public void postAuthenticate(OSDRequest rq) {
        ...
        master.getStage(Stages.AUTH).enqueueOperation(rq,  AuthenticationStage.STAGEOP_RETURN_LEASE, new StageCallbackInterface() {
