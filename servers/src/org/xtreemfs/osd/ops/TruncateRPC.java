...
public class TruncateRPC extends Operation {

    public TruncateRPC(RequestDispatcher master) {
        super(master);
    }
    ...
    protected void postAuthenticate(OSDRequest rq, StageResponseCode result) {
        ...
        if (result == StageResponseCode.OK) {
            ...
            master.getStage(Stages.STORAGE).enqueueOperation(rq, StorageThread.STAGEOP_TRUNCATE,
                new StageCallbackInterface() {
