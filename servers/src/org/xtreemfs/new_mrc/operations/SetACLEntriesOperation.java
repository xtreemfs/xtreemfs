...
public class SetACLEntriesOperation extends MRCOperation {
    ...
    public static final String RPC_NAME = "setACLEntries";
    ...
    public void startRequest(MRCRequest rq) {
        ...
        try {
            ...
            // change the ACL
            faMan.setACLEntries(sMan, file, res.getParentDirId(), rq.getDetails().userId, rq
    ...
    public ErrorRecord parseRPCBody(MRCRequest rq, List<Object> arguments) {
        ...
        try {
            ...
            args.entries = (Map<String, Object>) arguments.get(1);
