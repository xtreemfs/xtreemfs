...
public final class WriteOperation extends OSDOperation {
    ...
    public void startRequest(final OSDRequest rq) {
        ...
        master.getStorageStage().writeObject(args.getFile_id(), args.getObject_number(), rq.getLocationList().getLocalReplica().getStripingPolicy(),
                args.getOffset(), args.getData().getData(), rq.getCowPolicy(), rq,
