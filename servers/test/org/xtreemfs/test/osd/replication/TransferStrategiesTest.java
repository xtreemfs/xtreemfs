...
public class TransferStrategiesTest extends TestCase {
    ...
    public void testAddAndRemoveRequiredObject() {
        ...
        assertTrue(this.strategy.removeRequiredObject(this.details.getObjectNumber()));
    }
    ...
    public void testAddAndRemovePreferredObject() {
        ...
        assertTrue(this.strategy.removePreferredObject(this.details.getObjectNumber()));
    }
    ...
    public void testSelectNextForSimpleTransfer() {
        ...
        List<ServiceUUID> osds = this.details.getLocationList().getOSDsByObject(next.objectID);
