...
public class ExternalIntegrationTest extends TestCase {
    ...
    public void testCreateDelete() throws Exception {
        ...
        File file2 = createFile(new File(xtreemFSMountPoint + "/someOtherDir"),
            "testfile.tmp");
    ...
    private void delete(File fileOrDir) {
        ...
        assertEquals(numberOfChildren - 1,
            fileOrDir.getParentFile().list().length);
    }
