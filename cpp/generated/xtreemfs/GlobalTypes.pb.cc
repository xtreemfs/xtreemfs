...
void protobuf_AssignDesc_xtreemfs_2fGlobalTypes_2eproto() {
  ...
  static const int XCap_offsets_[11] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(XCap, priority_),
  };
  XCap_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      XCap_descriptor_,
...
void protobuf_AddDesc_xtreemfs_2fGlobalTypes_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    ".pbrpc.generatedinterfaces", 3106);
...
const int XCap::kPriorityFieldNumber;
#endif  // !_MSC_VER
...
void XCap::SerializeWithCachedSizes(
  ...
  // optional fixed32 priority = 11;
  if (has_priority()) {
    ::google::protobuf::internal::WireFormatLite::WriteFixed32(11, this->priority(), output);
  }
...
::google::protobuf::uint8* XCap::SerializeWithCachedSizesToArray(
  ...
  // optional fixed32 priority = 11;
  if (has_priority()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFixed32ToArray(11, this->priority(), target);
  }
