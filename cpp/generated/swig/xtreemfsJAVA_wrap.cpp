...
SWIGEXPORT jstring JNICALL Java_org_xtreemfs_common_libxtreemfs_jni_generated_xtreemfs_1jniJNI_FileHandleProxy_1getLastOSDAddress(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jstring jresult = 0 ;
  xtreemfs::FileHandle *arg1 = (xtreemfs::FileHandle *) 0 ;
  std::string result;
