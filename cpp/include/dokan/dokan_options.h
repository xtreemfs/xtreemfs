...
#ifndef CPP_INCLUDE_DOKAN_DOKAN_OPTIONS_H_
#define CPP_INCLUDE_DOKAN_DOKAN_OPTIONS_H_
...
class DokanOptions : public Options {
 public:
 ...
 private:
  /** Contains all available Dokan options and its descriptions. */
  boost::program_options::options_description dokan_descriptions_;
...
#endif  // CPP_INCLUDE_DOKAN_DOKAN_OPTIONS_H_
