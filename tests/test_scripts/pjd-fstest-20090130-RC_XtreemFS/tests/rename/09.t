...
expect_noop 0 -u 65533 -g 65533 mkfifo ${n0}/${n2} 0644
expect_noop 0 -u 65533 -g 65533 rename ${n0}/${n2} ${n1}/${n3}
expect_noop 0 unlink ${n1}/${n3}
...
expect_noop 0 chown ${n1} 65533 65533
expect_noop 0 -u 65534 -g 65534 mkfifo ${n0}/${n2} 0644
expect_noop "EACCES|EPERM" -u 65533 -g 65533 rename ${n0}/${n2} ${n1}/${n3}
