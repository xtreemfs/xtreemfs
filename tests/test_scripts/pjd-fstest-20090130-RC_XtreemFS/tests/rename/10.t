...
expect_noop 0 -u 65534 -g 65534 mkfifo ${n0}/${n2} 0644
expect_noop 0 -u 65534 -g 65534 rename ${n1}/${n3} ${n0}/${n2}
expect_noop ${inode} lstat ${n0}/${n2} inode
expect_noop ENOENT lstat ${n1}/${n3} inode
expect_noop 0 -u 65534 -g 65534 symlink test ${n1}/${n3}
expect_noop 0 -u 65534 -g 65534 rename ${n0}/${n2} ${n1}/${n3}
expect_noop ENOENT lstat ${n0}/${n2} inode
expect_noop ${inode} lstat ${n1}/${n3} inode
...
# User owns both: the sticky directory and the destination file.
expect_noop 0 chown ${n1} 65534 65534
expect_noop 0 -u 65534 -g 65534 mkfifo ${n0}/${n2} 0644
inode=`${fstest} lstat ${n0}/${n2} inode`
expect_noop 0 -u 65534 -g 65534 mkfifo ${n1}/${n3} 0644
expect_noop 0 -u 65534 -g 65534 rename ${n0}/${n2} ${n1}/${n3}
expect_noop ENOENT lstat ${n0}/${n2} inode
expect_noop ${inode} lstat ${n1}/${n3} inode
expect_noop 0 -u 65534 -g 65534 create ${n0}/${n2} 0644
expect_noop 0 -u 65534 -g 65534 rename ${n1}/${n3} ${n0}/${n2}
expect_noop ${inode} lstat ${n0}/${n2} inode
expect_noop ENOENT lstat ${n1}/${n3} inode
expect_noop 0 -u 65534 -g 65534 symlink test ${n1}/${n3}
...
expect_noop 0 -u 65534 -g 65534 mkfifo ${n1}/${n3} 0644
expect_noop 0 -u 65534 -g 65534 rename ${n0}/${n2} ${n1}/${n3}
expect_noop ENOENT lstat ${n0}/${n2} type
expect_noop ${inode} lstat ${n1}/${n3} inode
expect_noop 0 -u 65534 -g 65534 create ${n0}/${n2} 0644
expect_noop 0 -u 65534 -g 65534 rename ${n1}/${n3} ${n0}/${n2}
expect_noop ${inode} lstat ${n0}/${n2} inode
...
expect_noop 0 unlink ${n1}/${n3}
# User owns the destination file, but doesn't own the sticky directory.
expect_noop 0 chown ${n1} 65533 65533
expect_noop 0 -u 65534 -g 65534 mkfifo ${n0}/${n2} 0644
inode=`${fstest} lstat ${n0}/${n2} inode`
expect_noop 0 -u 65534 -g 65534 mkfifo ${n1}/${n3} 0644
expect_noop 0 -u 65534 -g 65534 rename ${n0}/${n2} ${n1}/${n3}
...
expect_noop 0 chown ${n1} 65533 65533
expect_noop 0 -u 65534 -g 65534 mkfifo ${n0}/${n2} 0644
expect_noop 0 -u 65533 -g 65533 mkfifo ${n1}/${n3} 0644
inode=`${fstest} lstat ${n1}/${n3} inode`
expect_noop "EACCES|EPERM" -u 65534 -g 65534 rename ${n0}/${n2} ${n1}/${n3}
expect_noop ${inode} lstat ${n1}/${n3} inode
expect_noop 0 unlink ${n0}/${n2}
expect_noop 0 unlink ${n1}/${n3}
