...
inode=`${fstest} lstat ${n0} inode`
expect_noop 0 rename ${n0} ${n1}
expect_noop ENOENT lstat ${n0} type,mode,nlink
expect_noop fifo,${inode},0644,1 lstat ${n1} type,inode,mode,nlink
expect_noop 0 link ${n1} ${n0}
expect_noop fifo,${inode},0644,2 lstat ${n0} type,inode,mode,nlink
expect_noop fifo,${inode},0644,2 lstat ${n1} type,inode,mode,nlink
expect_noop 0 rename ${n1} ${n2}
expect_noop fifo,${inode},0644,2 lstat ${n0} type,inode,mode,nlink
expect_noop ENOENT lstat ${n1} type,mode,nlink
expect_noop fifo,${inode},0644,2 lstat ${n2} type,inode,mode,nlink
...
ctime1=`${fstest} stat ${n0} ctime`
#sleep 1
expect_noop EACCES -u 65534 rename ${n0} ${n1}
ctime2=`${fstest} stat ${n0} ctime`
