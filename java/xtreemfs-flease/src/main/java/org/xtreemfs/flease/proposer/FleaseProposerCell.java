...
public class FleaseProposerCell {
    ...
    private final CellAction.CellActionList actions;
    ...
    FleaseProposerCell(ASCIIString cellId, List<InetSocketAddress> acceptors, long senderId) {
        this.actions = new CellAction.CellActionList();
        this.cellId = cellId;
    ...
    public void addAction(CellAction.ActionName actionName) {
        actions.addAction(actionName);
    }
    
    public void addAction(CellAction.ActionName actionName, String message) {
