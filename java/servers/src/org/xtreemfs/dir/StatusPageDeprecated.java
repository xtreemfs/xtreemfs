 ...
 * @author bjko
 */
public class StatusPageDeprecated {
    ...
    private static StringBuffer readTemplate(String template) {
        ...
        try {
            InputStream is = StatusPageDeprecated.class.getClassLoader().getResourceAsStream(
                    "org/xtreemfs/dir/templates/" + template);
            if (is == null) {
                is = StatusPageDeprecated.class.getClass().getResourceAsStream("../templates/" + template);
            }
