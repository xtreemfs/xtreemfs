...
public abstract class Volume {
	...
	public abstract StatVFS statFS(UserCredentials userCredentials)
	 ...
	 */
	// TODO: Create other Exceptions.
	public abstract String readLink(UserCredentials userCredentials, String path)
			throws IOException, PosixErrorException,
			AddressToUUIDNotFoundException;
	 ...
	 */
	// TODO: Create other Exceptions.
	public abstract void symlink(UserCredentials userCredentials,
			String targetPath, String linkPath) throws IOException,
	 ...
	 * @throws UnknownAddressSchemeException
	 */
	public abstract void link(UserCredentials userCredentials,
			String targetPath, String linkPath) throws IOException,
			PosixErrorException, PosixErrorException,
			AddressToUUIDNotFoundException;

	/**
	 * Tests if the subject described by "userCredentials" is allowed to access
	 ...
	 */
	// TODO: Create other Exceptions.
	public abstract void access(UserCredentials userCredentials, String path,
	 ...
	 */
	// TODO: Create other Exceptions.
	public abstract FileHandle openFile(UserCredentials userCredentials,
			String path, int flags) throws IOException, PosixErrorException,
			AddressToUUIDNotFoundException;
	 ...
	 */
	public abstract FileHandle openFile(UserCredentials userCredentials,
			String path, int flags, int mode) throws IOException,
			PosixErrorException, AddressToUUIDNotFoundException;
	 ...
	 * @throws UnknownAddressSchemeException
	 */
	public abstract void truncate(UserCredentials userCredentials, String path,
	 ...
	 * @throws UnknownAddressSchemeException
	 */
	public abstract Stat getAttr(UserCredentials userCredentials, String path)
			throws IOException, PosixErrorException,
			AddressToUUIDNotFoundException;
	 ...
	 * @throws UnknownAddressSchemeException
	 */
	public abstract void setAttr(UserCredentials userCredentials, String path,
			Stat stat, int toSet) throws IOException, PosixErrorException,
			AddressToUUIDNotFoundException;
	 ...
	 * @throws UnknownAddressSchemeException
	 */
	public abstract void unlink(UserCredentials userCredentials, String path)
			throws IOException, PosixErrorException,
			AddressToUUIDNotFoundException;
	 ...
	 * @throws UnknownAddressSchemeException
	 * */
	public abstract void rename(UserCredentials userCredentials, String path,
			String newPath) throws IOException, PosixErrorException,
			AddressToUUIDNotFoundException;
	 ...
	 * @throws UnknownAddressSchemeException
	 */
	public abstract void createDirectory(UserCredentials userCredentials,
			String path, int mode) throws IOException, PosixErrorException,
			AddressToUUIDNotFoundException;
	 ...
	 * @throws UnknownAddressSchemeException
	 */
	public abstract void removeDirectory(UserCredentials userCredentials,
			String path) throws IOException, PosixErrorException,
			AddressToUUIDNotFoundException;
	 ...
	 * 
	 * {@link DirectoryEntries} will contain the names of the entries and, if
	 * not disabled by "namesOnly", a {@link Stat} object for every entry.
	 * 
	 * @param userCredentials
	 *            Name and Groups of the user.
	 * @param path
	 ...
	 * @param namesOnly
	 *            If set to true, the {@link Stat} object of every entry will be
	 *            omitted.
	 * 
	 * @throws AddressToUUIDNotFoundException
	 * @throws {@link IOException}
	 ...
	 */
	public abstract DirectoryEntries readDir(UserCredentials userCredentials,
			String path, int offset, int count, boolean namesOnly)
			throws IOException, PosixErrorException,
			AddressToUUIDNotFoundException;

	/**
	 * Returns the list of extended attributes stored for "path" (Entries may be
	 * cached).
	 * 
	 * @param userCredentials
	 *            Name and Groups of the user.
	 ...
	 * @remark Ownership is transferred to the caller.
	 */
	public abstract listxattrResponse listXAttrs(
			UserCredentials userCredentials, String path) throws IOException,
			PosixErrorException, AddressToUUIDNotFoundException;

	/**
	 * Returns the list of extended attributes stored for "path" (Set "useCache"
	 ...
	 */
	public abstract listxattrResponse listXAttrs(
			UserCredentials userCredentials, String path, boolean useCache)
			throws IOException, PosixErrorException,
			AddressToUUIDNotFoundException;
	 ...
	 * @throws UnknownAddressSchemeException
	 */
	public abstract void setXAttr(UserCredentials userCredentials, String path,
	 ...
	 * @param name
	 *            Name of the extended attribute.
	 * @return String Will contain the content of the extended attribute. NULL
	 ...
	 * 
	 */
	public abstract String getXAttr(UserCredentials userCredentials,
			String path, String name) throws IOException, PosixErrorException,
			AddressToUUIDNotFoundException;
	 ...
	 * @param name
	 *            Name of the extended attribute.
	 * @param int Size of the extended attribute. -1 if the attribute was not
	 *        found.
	 * 
	 * @throws AddressToUUIDNotFoundException
	 * @throws {@link IOException}
	 ...
	 */
	public abstract int getXAttrSize(UserCredentials userCredentials,
			String path, String name) throws IOException, PosixErrorException,
			AddressToUUIDNotFoundException;
	 ...
	 * @throws UnknownAddressSchemeException
	 */
	public abstract void removeXAttr(UserCredentials userCredentials,
			String path, String name) throws IOException, PosixErrorException,
			AddressToUUIDNotFoundException;
	 ...
	 * @throws PosixErrorException
	 * */
	public abstract void addReplica(UserCredentials userCredentials,
			String path, Replica newReplica) throws IOException,
			PosixErrorException, AddressToUUIDNotFoundException;
	 ...
	 * @remark Ownership is transferred to the caller.
	 */
	public abstract Replicas listReplicas(UserCredentials userCredentials,
			String path) throws IOException, PosixErrorException,
			AddressToUUIDNotFoundException;

	/**
	 * Removes the replica of file at "path" located on the OSD with the UUID
	 * "osdUuid" (which has to be the head OSD in case of striping).
	 * 
	 * @param userCredentials
	 *            Username and groups of the user.
	 * @param path
	 ...
	 * @throws UnknownAddressSchemeException
	 */
	public abstract void removeReplica(UserCredentials userCredentials,
			String path, String osdUuid) throws IOException,
			PosixErrorException, AddressToUUIDNotFoundException;

	/**
	 * Adds to "listOfOsdUuids" up to "numberOfOsds" UUIDs of all available OSDs
	 * where the file (described by "path") can be placed.
	 * 
	 * @param userCredentials
	 *            Username and groups of the user.
	 * @param path
	 ...
	 * @throws PosixErrorException
	 */
	public abstract List<String> getSuitableOSDs(
			UserCredentials userCredentials, String path, int numberOfOsds)
			throws IOException, PosixErrorException,
			AddressToUUIDNotFoundException;
}
