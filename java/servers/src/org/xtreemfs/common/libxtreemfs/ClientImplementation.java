...
public class ClientImplementation extends Client implements UUIDResolver {
    ...
    protected ClientImplementation(String dirAddress, UserCredentials userCredentials, SSLOptions sslOptions,
        ...
        if (Logging.isDebug()) {
            Logging.logMessage(Logging.LEVEL_DEBUG, this, "Created a new libxtreemfs Client " + "object (version %s)",
                    options.getVersion());
        }
     ...
     * org.xtreemfs.common.libxtreemfs.Options)
     */
    @Override
     ...
     * 
     * @see
     * org.xtreemfs.common.libxtreemfs.Client#createVolume(java.lang.String,
     * org.xtreemfs.foundation.pbrpc.generatedinterfaces.RPC.Auth,
     * org.xtreemfs.common.auth.UserCredentials, java.lang.String, int,
     * java.lang.String, java.lang.String,
     * org.xtreemfs.pbrpc.generatedinterfaces
     * .GlobalTypes.AccessControlPolicyType,
     * org.xtreemfs.pbrpc.generatedinterfaces.GlobalTypes.StripingPolicyType,
    ...
    private void createVolume(UUIDIterator mrcAddresses, Auth auth, UserCredentials userCredentials, String volumeName,
            int mode, String ownerUsername, String ownerGroupname, AccessControlPolicyType accessPolicyType,
            StripingPolicyType defaultStripingPolicyType, int defaultStripeSize, int defaultStripeWidth,
            List<KeyValuePair> volumeAttributes) throws IOException, PosixErrorException,
            AddressToUUIDNotFoundException {
     ...
     * 
     * @see
     * org.xtreemfs.common.libxtreemfs.Client#deleteVolume(java.lang.String,
     * org.xtreemfs.foundation.pbrpc.generatedinterfaces.RPC.Auth,
     * org.xtreemfs.common.auth.UserCredentials, java.lang.String)
     */
    @Override
    ...
    private void deleteVolume(UUIDIterator mrcAddresses, Auth auth, UserCredentials userCredentials, String volumeName)
            throws IOException, PosixErrorException, AddressToUUIDNotFoundException {
        final MRCServiceClient mrcServiceClient = new MRCServiceClient(networkClient, null);
        
        RPCCaller.<String, emptyResponse> syncCall(SERVICES.MRC, userCredentials, auth, options, this, mrcAddresses,
                true, volumeName, new CallGenerator<String, emptyResponse>() {
                    @SuppressWarnings("unchecked")
                    @Override
    ...
    private Volumes listVolumes(UUIDIterator uuidIteratorWithAddresses) throws IOException, PosixErrorException,
            AddressToUUIDNotFoundException {
        final MRCServiceClient mrcServiceClient = new MRCServiceClient(networkClient, null);
        ...
        Volumes volumes = RPCCaller.<emptyRequest, Volumes> syncCall(SERVICES.MRC, userCredentials, authBogus, options,
     ...
     * 
     * @see
     * org.xtreemfs.common.libxtreemfs.UUIDResolver#uuidToAddress(java.lang.
     ...
     * 
     * @see
     * org.xtreemfs.common.libxtreemfs.UUIDResolver#volumeNameToMRCUUID(java
    ...
    public String volumeNameToMRCUUID(String volumeName) throws VolumeNotFoundException, AddressToUUIDNotFoundException {
        ...
        try {
            sSet = RPCCaller.<String, ServiceSet> syncCall(SERVICES.DIR, dirServiceUserCredentials, dirServiceAuth,
                    options, this, dirServiceAddresses, true, parsedVolumeName,
     ...
     * @see
     * org.xtreemfs.common.libxtreemfs.UUIDResolver#volumeNameToMRCUUID(java
     * .lang.String, org.xtreemfs.common.libxtreemfs.UUIDIterator)
     */
    @Override
    ...
    /**
     * If volumeName contains an '@', cut off everything after the at because
     * this belongs to the snapshot. The real volumename is everything before
     * the '@'.
     * 
     * @param volumeName
