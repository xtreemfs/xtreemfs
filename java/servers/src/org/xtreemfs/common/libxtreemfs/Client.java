...
public abstract class Client {
   ...
   */
  public void
  createVolume(String mrcAddress, Auth auth, UserCredentials userCredentials, String volumeName)
   ...
   *            time of the volume.
   */
  public abstract void createVolume(Auth auth, UserCredentials userCredentials,
  ...
  /**
   * Retrieves the first MRC from the DIR and
   * deletes the volume "volume_name" at this the MRC.
   * 
   * @param auth
   *            Authentication data, e.g. of type AUTH_PASSWORD.
   * @param userCredentials
   ...
   * @throws PosixErrorException
   */
  public abstract void deleteVolume(Auth auth, UserCredentials userCredentials,
      String volumeName) throws IOException, PosixErrorException, AddressToUUIDNotFoundException;
