...
public abstract class Client {
	 ...
	 *            Address of the DIR service (Format: ip-addr:port, e.g.
	 *            localhost:32638)
	 ...
	 */
	public static Client createClient(String dirServiceAddress,
			UserCredentials userCredentials, SSLOptions sslOptions,
			Options options) {
		return createClient(dirServiceAddress, userCredentials, sslOptions,
				options, ClientImplementationType.kDefaultClient);
	}

	/** Returns an instance of the chosen Client implementation. */
	public static Client createClient(String dirServiceAddress,
			UserCredentials userCredentials, SSLOptions sslOptions,
			Options options, ClientImplementationType type) {

		switch (type) {
		case kDefaultClient:
			return new ClientImplementation(dirServiceAddress, userCredentials,
					sslOptions, options);
		default:
			return null;
		}
	 ...
	 */
	public abstract Volume openVolume(String volumeName, SSLOptions sslOptions,
	 ...
	 */
	public void createVolume(String mrcAddress, Auth auth,
			UserCredentials userCredentials, String volumeName)
		...
		createVolume(mrcAddress, auth, userCredentials, volumeName, 511, "",
				...
				StripingPolicyType.STRIPING_POLICY_RAID0, 128, 1,
				volumeAttributes);
	};
	 ...
	 * @throws PosixErrorException
	 */
	public void createVolume(List<String> mrcAddresses, Auth auth,
			UserCredentials userCredentials, String volumeName)
			throws IOException, PosixErrorException, AddressToUUIDNotFoundException {
		List<KeyValuePair> volumeAttributes = new ArrayList<KeyValuePair>();
	 ...
	 *            Name of the new volume.
	 * @param mode
	 *            Mode of the volume's root directory (in octal representation
	 *            (e.g. 511), not decimal (777)).
	 * @param ownerUsername
	 ...
	 *            which will bet set at creation time of the volume.
	 * 
	 * @throws IOException
	 * @throws PosixErrorException
	 */
	public abstract void createVolume(String mrcAddress, Auth auth,
			UserCredentials userCredentials, String volumeName, int mode,
			String ownerUsername, String ownerGroupname,
			AccessControlPolicyType accessPolicyType,
			StripingPolicyType defaultStripingPolicyType,
			int defaultStripeSize, int defaultStripeWidth,
			List<KeyValuePair> volumeAttributes) throws IOException,
	 ...
	 * @throws PosixErrorException
	 */
	public abstract void createVolume(List<String> mrcAddresses, Auth auth,
			UserCredentials userCredentials, String volumeName, int mode,
			String ownerUsername, String ownerGroupname,
			AccessControlPolicyType accessPolicyType,
			StripingPolicyType defaultStripingPolicyType,
	 ...
	 * @throws PosixErrorException
	 */
	public abstract void deleteVolume(String mrcAddress, Auth auth,
			UserCredentials userCredentials, String volumeName)
			throws IOException, PosixErrorException, AddressToUUIDNotFoundException;
	 ...
	 * @throws PosixErrorException
	 */
	public abstract void deleteVolume(List<String> mrcAddresses, Auth auth,
			UserCredentials userCredentials, String volumeName)
			throws IOException, PosixErrorException, AddressToUUIDNotFoundException;
	 ...
	 * 
	 * @param List
	 *            <String> List which contains MRC addresses of the
	 *            form "hostname:port".
	 * 
	 * @throws AddressToUUIDNotFoundException
	 * @throws IOException
	 ...
	 */
	public abstract Volumes listVolumes(List<String> mrcAddresses)
			throws IOException, PosixErrorException, AddressToUUIDNotFoundException;
}
