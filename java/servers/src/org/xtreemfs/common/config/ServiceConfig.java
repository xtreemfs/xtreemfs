...
public class ServiceConfig extends Config {
    ...
    public static enum Parameter {
        ...
        DEBUG_LEVEL("debug.level", 6, Integer.class, false), DEBUG_CATEGORIES("debug.categories", debugCategoryDefault,
                ...
                Integer.class, false), MAX_CLIENT_Q("max_client_queue", 100, Integer.class, false),
        ...
        AUTODISCOVER_ENABLED("discover", true, Boolean.class, false), MONITORING_ENABLED("monitoring.enabled", false,
                ...
                "vivaldi.client_timeout", 600000, Integer.class, false), // default: twice the recalculation
                                                                         // interval
        ...
        UUID("uuid", null, ServiceUUID.class, true), LOCAL_CLOCK_RENEW("local_clock_renewal", null, Integer.class, true), REMOTE_TIME_SYNC(
                ...
                "renew_to_caps", false, Boolean.class, false), ENABLE_LOCAL_FIFOS("enable_local_FIFOs", false,
                Boolean.class, false),
        ...
        OBJECT_DIR("object_dir", null, String.class, true), REPORT_FREE_SPACE("report_free_space", null, Boolean.class,
                ...
                Boolean.class, false), FLEASE_DMAX_MS("flease.dmax_ms", 1000, Integer.class, false), FLEASE_LEASE_TIMEOUT_MS(
                "flease.lease_timeout_ms", 15000, Integer.class, false), FLEASE_MESSAGE_TO_MS("flease.message_to_ms",
                500, Integer.class, false), FLEASE_RETRIES("flease.retries", 3, Integer.class, false), SOCKET_SEND_BUFFER_SIZE(
                "socket.send_buffer_size", -1, Integer.class, false), SOCKET_RECEIVE_BUFFER_SIZE(
                "socket.recv_buffer_size", -1, Integer.class, false), VIVALDI_RECALCULATION_INTERVAL_IN_MS(
                "vivaldi.recalculation_interval_in_ms", 300000, Integer.class, false), VIVALDI_RECALCULATION_EPSILON_IN_MS(
                "vivaldi_recalculation_interval_in_ms", 30000, Integer.class, false), VIVALDI_ITERATIONS_BEFORE_UPDATING(
                ...
                "vivaldi.max_request_timeout_in_ms", 10000, Integer.class, false), VIVALDI_TIMER_INTERVAL_IN_MS(
                "vivaldi.timer_interval_in_ms", 60000, Integer.class, false), OPEN_STATE_IMPLICIT_CLOSE_TIMEOUT(
                "open_state.implicit_close_timeout", 30000, Integer.class, false), OPEN_STATE_OFT_CLEANUP_INTERVAL(
                "open_state.oft_cleanup_interval", 60000, Integer.class, false);
