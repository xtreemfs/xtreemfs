 ...
 *  
 * @author flangner
 * @version 1.00, 01/16/12
 * @see StageQueue
 * <R> - type for the queued requests. Has to extend {@link AugmentedRequest}.
 */
class ProtectedPriorityQueue<R extends AugmentedRequest> implements StageQueue<R> {
     ...
     */
    ProtectedPriorityQueue(ProtectionAlgorithmCore olp) {
