...
/**
 * <p>Contains routines to measure execution time. During a processing step the processing time is collected additively until it's summarized and send to the OLP 
 * monitor.</p>
...
public class RequestMonitoring {
    ...
    public RequestMonitoring() {
        ...
        piggybackPerformanceReceiver = null;
    }
     ...
     */
    public RequestMonitoring(PerformanceInformationReceiver piggybackPerformanceInformationReceiver) {
