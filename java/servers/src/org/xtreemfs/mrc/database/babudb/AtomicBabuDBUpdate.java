...
public class AtomicBabuDBUpdate implements AtomicDBUpdate {
    ...
    private BabuDBComponent<MRCRequest>     component;
    
    private Database                        database;
            
    public AtomicBabuDBUpdate(Database database, BabuDBComponent<MRCRequest> component) {
    ...
    public void execute(Callback callback, MRCRequest request) throws DatabaseException {
        ...
        if (callback != null) {
            ...
            component.insert(database, callback, ig, request);        
        } else {
