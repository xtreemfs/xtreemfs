...
public class ControllerTest {
    ...
    public void fullFastBenchmarkSuite() throws Exception {
        ...
        results = controller.startBenchmarks(BenchmarkType.READ, 1);
        Controller.printResults(results);
        // results = controller.startBenchmarks(BenchmarkType.RANDOM_IO_READ, 1, MiB_IN_BYTES);
        // controller.printResults(results);
        results = controller.startBenchmarks(BenchmarkType.RANDOM_IO_WRITE_FILEBASED, 1);
        Controller.printResults(results);
        results = controller.startBenchmarks(BenchmarkType.RANDOM_IO_WRITE_FILEBASED, 1);
        Controller.printResults(results);
        controller.teardown();
