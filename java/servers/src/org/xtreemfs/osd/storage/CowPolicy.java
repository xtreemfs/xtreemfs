...
public class CowPolicy {
    ...
    public enum cowMode {
        ...
        NO_COW,
        /**
         * Create a copy only for the first write after open, then overwrite for each subsequent request.
         */
        COW_ONCE,
        /**
    ...
    /**
     * per-object flag which indicates if the object has already been copied (for COW_ONCE mode). Each bit is
     * used
     */
