...
public class EventCloseFile extends OSDOperation {
    ...
    public void startInternalEvent(Object[] args) {
        ...
        master.getStorageStage().flushCaches(fileId, new CachesFlushedCallback() {
            ...
            public void cachesFlushed(ErrorResponse error, FileMetadata md) {
                ...
                if (cow.cowEnabled())
                    createNewVersion(fileId, md, cachedCaps, isDeleteOnClose);

                // if the file is marked for deletion, delete it
                else if (isDeleteOnClose)
                    deleteObjects(fileId, md, cow.cowEnabled());
    ...
    public void createNewVersion(final String fileId, final FileMetadata fi, LRUCache<String, Capability> cachedCaps,
