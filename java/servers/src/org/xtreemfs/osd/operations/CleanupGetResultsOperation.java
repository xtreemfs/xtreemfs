...
public final class CleanupGetResultsOperation extends OSDOperation {
    ...
    public int getProcedureId() {
        return OSDServiceConstants.PROC_ID_XTREEMFS_CLEANUP_GET_RESULTS;
    }
    ...
    public ErrorResponse startRequest(OSDRequest rq, RPCRequestCallback callback) {
        ...
        callback.success(xtreemfs_cleanup_get_resultsResponse.newBuilder().addAllResults(
                master.getCleanupThread().getResult()).build());
