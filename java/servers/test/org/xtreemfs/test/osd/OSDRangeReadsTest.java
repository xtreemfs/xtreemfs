...
public class OSDRangeReadsTest extends TestCase {
    ...
    public void testRandomRanges() throws Exception {
        ...
        RPCResponse<OSDWriteResponse> r = osdClient.write(serverID.getAddress(), RPCAuthentication.authNone,
                RPCAuthentication.userService, fcred, fileId, 0, 0, 0, 0, data, -1, buf);
    ...
    public void testRangeReads() throws Exception {
        ...
        /*
         * layout is obj 0: never written, does not exist on disk obj 1: 1024 written, 1024 implicit padding
         * obj 2: 1024 written
         */
