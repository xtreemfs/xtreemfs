...
public class ClientTest {
    ...
    public void testCreateOpenRemoveListVolume() throws Exception {
        ...
        sSet = dirClient.xtreemfs_service_get_by_name(testEnv.getDIRAddress(), auth, userCredentials, VOLUME_NAME_1);
    ...
    public void testMinimalExampleWithAsyncWritesAndStriping() throws Exception {
        ...
        // Open a volume named "foobar".
        client.createVolume(mrcAddress, auth, userCredentials, VOLUME_NAME_1, 0777, userCredentials.getUsername(),
                userCredentials.getGroupsList().get(0), AccessControlPolicyType.ACCESS_CONTROL_POLICY_NULL,
                StripingPolicyType.STRIPING_POLICY_RAID0, 4, 2, new ArrayList<KeyValuePair>());
        Volume volume = client.openVolume(VOLUME_NAME_1, null, options);
