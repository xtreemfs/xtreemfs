...
/**
 * The class is used for representing SNMP metadata for the "Mrc" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.38350.3.
 */
public class MrcMeta extends SnmpMibGroup
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "Mrc".
     */
    public MrcMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 1:
                return new SnmpInt(node.getVolumeCount());
     ...
     */
    protected void setInstance(MrcMBean var) {
        node = var;
    }
