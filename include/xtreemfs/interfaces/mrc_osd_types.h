  ...
  namespace xtreemfs
  {
    namespace interfaces
    {
      ...
      public:
        ...
        // yidl::runtime::Object
        YIDL_RUNTIME_OBJECT_PROTOTYPES( NewFileSize, 2010022226 );
      ...
      public:
        ...
        // yidl::runtime::Object
        YIDL_RUNTIME_OBJECT_PROTOTYPES( NewFileSizeSet, 2010022227 );
      ...
      public:
        ...
        // yidl::runtime::Object
        YIDL_RUNTIME_OBJECT_PROTOTYPES( OSDWriteResponse, 2010022232 );
  
        // yidl::Struct
        void marshal( ::yidl::runtime::Marshaller& marshaller ) const { marshaller.writeSequence( "new_file_size", 0, new_file_size ); }
        void unmarshal( ::yidl::runtime::Unmarshaller& unmarshaller ) { unmarshaller.readSequence( "new_file_size", 0, new_file_size ); }
      ...
      public:
        ...
        // yidl::runtime::Object
        YIDL_RUNTIME_OBJECT_PROTOTYPES( StripingPolicy, 2010022234 );
      ...
      public:
        ...
        // yidl::runtime::Object
        YIDL_RUNTIME_OBJECT_PROTOTYPES( Replica, 2010022235 );
      ...
      public:
        ...
        // yidl::runtime::Object
        YIDL_RUNTIME_OBJECT_PROTOTYPES( ReplicaSet, 2010022236 );
      ...
      public:
        ...
        // yidl::runtime::Object
        YIDL_RUNTIME_OBJECT_PROTOTYPES( VivaldiCoordinates, 2010022237 );
      ...
      public:
        ...
        XCap( uint32_t access_mode, const char* client_identity, size_t client_identity_len, uint64_t expire_time_s, uint32_t expire_timeout_s, const char* file_id, size_t file_id_len, bool replicate_on_close, const char* server_signature, size_t server_signature_len, uint32_t truncate_epoch, org::xtreemfs::interfaces::SnapConfig snap_config, uint64_t snap_timestamp ) : access_mode( access_mode ), client_identity( client_identity, client_identity_len ), expire_time_s( expire_time_s ), expire_timeout_s( expire_timeout_s ), file_id( file_id, file_id_len ), replicate_on_close( replicate_on_close ), server_signature( server_signature, server_signature_len ), truncate_epoch( truncate_epoch ), snap_config( snap_config ), snap_timestamp( snap_timestamp ) { }
        virtual ~XCap() { }
      ...
      public:
        ...
        // yidl::runtime::Object
        YIDL_RUNTIME_OBJECT_PROTOTYPES( XLocSet, 2010022239 );
      ...
      public:
        ...
        // yidl::runtime::Object
        YIDL_RUNTIME_OBJECT_PROTOTYPES( FileCredentials, 2010022240 );
      ...
      public:
        ...
        // yidl::runtime::Object
        YIDL_RUNTIME_OBJECT_PROTOTYPES( FileCredentialsSet, 2010022241 );
