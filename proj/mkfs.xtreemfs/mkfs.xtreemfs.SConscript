...
include_dir_paths = [os.path.abspath( '../../share/google-breakpad/src' ), os.path.abspath( '../../share/yidl/include' ), os.path.abspath( '../../share/yield/src' ), os.path.abspath( '../../share/yieldfs/include' ), os.path.abspath( '../../share/yield/include' ), os.path.abspath( '../../include' )]
...
build_env.Program( "../../bin/mkfs.xtreemfs", (
    r"../../src/mkfs.xtreemfs/mkfs.xtreemfs.cpp" ) )
